...
--
-- Anamakine: localhost
-- Üretim Zamanı: 03 Ağu 2017, 18:04:25
...
(3, 'Tişörtler', 5, 'tisortler', 2, '1'),
(4, 'Pantolon', 0, 'pantolon', 3, '1'),
(5, 'Bluecin', 6, 'bluecin', 4, '1'),
(6, 'Bluz', 4, 'bluz', 5, '1'),
(7, 'Şapkalar', 0, 'sapkalar', 3, '1'),
(10, 'Tişörtler Alt', 2, 'tisortler', 2, '1');
...
(152, '2017-07-16 17:40:24', '', '', '', 'info@muratharuns.com', '', 'e10adc3949ba59abbe56e057f20f883e', 'Murat Harun', '', '', '', '', '1', 1),
...
(6, 'Slider 4', 'dimg/slider/27613272132172620462slide-4.jpg', 4, '', '1');
...
--
ALTER TABLE `urunfoto`
  MODIFY `urunfoto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
--
